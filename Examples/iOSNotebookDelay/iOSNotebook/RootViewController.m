...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *syncButton = [[UIBarButtonItem alloc]
                                   ...
                                   target:[[UIApplication sharedApplication]
                                           delegate] 
                                   action:@selector(beginSynchronizing:)];
...
{
    TINBNote *note = [self.fetchedResultsController objectAtIndexPath:indexPath];
...
- (void)insertNewObject
{
    ...
    TINBNote *newNote = [NSEntityDescription insertNewObjectForEntityForName:[entity name] inManagedObjectContext:context];
    ...
    NoteViewController *noteVC = [[NoteViewController alloc] initWithNote:newNote];
    [noteVC setEditing:YES animated:NO];
