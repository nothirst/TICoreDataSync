//
//  TICDSiCloudBasedDocumentSyncManager.m
//  ShoppingListMac
//
...
@implementation TICDSiCloudBasedDocumentSyncManager
...
{
    if( [anAppSyncManager isKindOfClass:[TICDSiCloudBasedApplicationSyncManager class]] ) {
        [self setApplicationDirectoryPath:[(TICDSiCloudBasedApplicationSyncManager *)anAppSyncManager applicationDirectoryPath]];
    }
...
{
    if( [[self applicationSyncManager] isKindOfClass:[TICDSiCloudBasedApplicationSyncManager class]] ) {
        [self setApplicationDirectoryPath:[(TICDSiCloudBasedApplicationSyncManager *)[self applicationSyncManager] applicationDirectoryPath]];
    }
...
{
    TICDSiCloudBasedDocumentRegistrationOperation *operation = [[TICDSiCloudBasedDocumentRegistrationOperation alloc] initWithDelegate:self];
...
{
    TICDSiCloudBasedWholeStoreUploadOperation *operation = [[TICDSiCloudBasedWholeStoreUploadOperation alloc] initWithDelegate:self];
...
{
    TICDSiCloudBasedPreSynchronizationOperation *operation = [[TICDSiCloudBasedPreSynchronizationOperation alloc] initWithDelegate:self];
...
{
    TICDSiCloudBasedPostSynchronizationOperation *operation = [[TICDSiCloudBasedPostSynchronizationOperation alloc] initWithDelegate:self];
...
{
    TICDSiCloudBasedVacuumOperation *operation = [[TICDSiCloudBasedVacuumOperation alloc] initWithDelegate:self];
...
{
    TICDSiCloudBasedListOfDocumentRegisteredClientsOperation *operation = [[TICDSiCloudBasedListOfDocumentRegisteredClientsOperation alloc] initWithDelegate:self];
...
{
    TICDSiCloudBasedDocumentClientDeletionOperation *operation = [[TICDSiCloudBasedDocumentClientDeletionOperation alloc] initWithDelegate:self];
