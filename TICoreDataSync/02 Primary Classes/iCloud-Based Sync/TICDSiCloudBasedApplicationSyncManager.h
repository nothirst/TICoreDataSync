//
//  TICDSiCloudBasedApplicationSyncManager.h
//  ShoppingListMac
//
...
/** The `TICDSiCloudBasedApplicationSyncManager` describes a class used to synchronize an application with a remote service that can be accessed via an `NSFileManager`. This includes:
...
@interface TICDSiCloudBasedApplicationSyncManager : TICDSApplicationSyncManager {
@private
