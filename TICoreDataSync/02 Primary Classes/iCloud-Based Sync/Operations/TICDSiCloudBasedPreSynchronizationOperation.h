//
//  TICDSiCloudBasedPreSynchronizationOperation.h
//  ShoppingListMac
//
...
/**
 `TICDSiCloudBasedPreSynchronizationOperation` is a synchronization operation designed for use with a `TICDSiCloudBasedDocumentSyncManager`.
 */

@interface TICDSiCloudBasedPreSynchronizationOperation : TICDSPreSynchronizationOperation {
@private
