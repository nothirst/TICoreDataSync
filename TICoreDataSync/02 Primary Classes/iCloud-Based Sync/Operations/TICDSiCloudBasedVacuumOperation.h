//
//  TICDSiCloudBasedVacuumOperation.h
//  ShoppingListMac
//
...
/**
 `TICDSiCloudBasedVacuumOperation` is a vacuum operation designed for use with a `TICDSiCloudBasedDocumentSyncManager`.
 */

@interface TICDSiCloudBasedVacuumOperation : TICDSVacuumOperation {
@private
